package com.fl.wx.pay.sdk;

import java.util.HashMap;
import java.util.Map;

import com.fl.common.CommonHelp;
import com.fl.wx.pay.sdk.WXPayConstants.SignType;
public class WXPay {
...
//        }
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        String reqBody = CommonHelp.mapToXml(reqData);
    ...
    public Map<String, String> processResponseXml(String xmlStr) throws Exception {
        ...
        String return_code;
        Map<String, String> respData = CommonHelp.xmlToMap(xmlStr);
    ...
    public Map<String, String> downloadBill(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        if (respStr.indexOf("<") == 0) {
            ret = CommonHelp.xmlToMap(respStr);
        }
        else {
            // 正常返回csv数据
    ...
    public Map<String, String> report(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return CommonHelp.xmlToMap(respXml);
    }
