    ...
    function asyncUpload(localIds) {
        ...
        wx.uploadImage({
            ...
            success: function (resup) {
                ...
                if (isAndroid()) {
                    var str = '<li class="weui-uploader__file"  serverId="' + serverId + '"  onclick="imgdel(this)"  >';
                ...
                if (data != "") {
                    ...
                    if (js.length > 0) {
                        ...
                        for (var i = 0; i < js.length; i++) {
                            str += '<li class="weui-uploader__file" onclick="filedel(this,\'' + js[i].aguid + '\')"  style="background-image:url(<%=basePath%>' + js[i].zoompath + ')">';
