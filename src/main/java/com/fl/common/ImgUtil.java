...
public class ImgUtil {
    ...
    public boolean ThumbnailsImgMultipartFile(int baseSize, MultipartFile picfile, String toPic) {
        try {
            return ThumbnailsImg(baseSize, picfile.getInputStream(), toPic, picfile.getSize());
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        }
     ...
     * @param toPic，压缩图片保存路径
     */
    public boolean ThumbnailsImg(int baseSize, InputStream in, String toPic, long length) {
        try {
