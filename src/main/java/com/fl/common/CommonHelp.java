...
public class CommonHelp {
    ...
    public static String ConvertToJson(Object ob) {
        ObjectMapper objectMapper = new ObjectMapperCustomer();
        // 设置日期格式
     ...
     * @return
     */
    public static Object ConvertToOjb(String json) {
        ObjectMapper objectMapper = new ObjectMapperCustomer();
        // 设置日期格式
        SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        objectMapper.setDateFormat(fmt);
     ...
     * 获取配置文件对象
     *
     * @param path 配置文件路径，如config/db.properties
     * @return
     */
    // public static ResourceBundle getProperty(String path) {
    ...
    public static Properties getProperty(String path) {
        InputStream in = CommonHelp.class.getClassLoader().getResourceAsStream(path);
        Properties pro = new Properties();
        try {
            pro.load(in);
        } catch (IOException e) {
            log.error(path + "属性文件加载失败", e);
        }
        return pro;
    }
     ...
     * @return
     */
    public static String getPropertyKey(Properties pro, String key) {
     ...
     * @return
     */
    public static Map<String, String> getPropertyMap(Properties pro) {
        Map<String, String> map = new HashMap<String, String>();
        Set<String> it = pro.stringPropertyNames();
        for (String item : it) {
            map.put(item, pro.getProperty(item));
        }
        return map;
    }

    public static Object setPropertyKey(Properties pro, String key, String value) {
    ...
    public static Map<String, String> xmlToMap(String strXML) throws Exception {
        try {
            ...
            com.fl.wx.pay.sdk.WXPayUtil.getLogger().warn("Invalid XML, can not convert to map. Error message: {}. XML content: {}", ex.getMessage(), strXML);
            throw ex;
        }
    }
    ...
    /**
     * @param im           原始图片
     * @param fileFullPath 压缩图片保持路径
     * @param quality      压缩图片质量
     * @return
     */
    public static boolean FileToYSFile(BufferedImage im, String fileFullPath, float quality) {
        if (TypeUtils.isImage(fileFullPath) && im != null) {
            try {
                /*输出到文件流*/
