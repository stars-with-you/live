...
<div class="layui-body">
    <div class="layui-card">
        <div class="layui-card-body">
            <a href="<%=basePath%>survey/create" class="layui-btn  layui-btn-normal  layui-btn-sm"
        ...
        tableIns = table.render({
            ...
            cols: [[{
                ...
                templet: function (d) {
                    var str = "";
                    if (d.isedit != '1') {
                        str += '<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a><a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>';
                    }
                    str += '<a class="layui-btn layui-btn-normal layui-btn-xs" target="_blank" href="<%=basePath%>survey/answer?sid=' + d.sid + '">答题</a><a class="layui-btn layui-btn-danger layui-btn-xs"  target="_blank" href="<%=basePath%>survey/tj?sid=' + d.sid + '" >统计</a>';
                    return str;
                }
            }]]
        });
